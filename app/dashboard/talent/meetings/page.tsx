...
export default function TalentMeetingsPage() {
  ...
  return (
    <PageWrap>
      <PageHead eyebrow="Talent" title="Meetings" desc="Your scheduled project meetings and calls." />
      {meetings.length === 0 ? (
        <Empty title="No meetings scheduled" hint="Meetings will appear here once discovery calls are scheduled for your projects." />
      ) : (
        <StaggerContainer>
